...
const CookieLessFuture = () => {
  ...
  return (
    <div className='bg-[url("/images/cookieless_banner.png")] bg-no-repeat bg-cover bg-top   py-[180px]'>
      <div className="md:max-w-[1300px] w-full mx-auto  xl:px-0 px-5">
        <h1 className="text-white font-bold text-5xl text-center leading-[66px]">
       ...
       <p className="text-white text-2xl font-medium text-center lg:max-w-[1030px] w-full mx-auto">Tap the world&apos;s largest publisher collective for deep consumer insights and enriched audience data. Then get out there and rule the roost.</p>
      </div>
    </div>
  );
};
...
const CardComp = (props) => {
  ...
  return (
      <div className="inline-block">
        ...
        <p className="text-white text-3xl font-medium bg-[#1F57A1] rounded-full  min-w-[134px] min-h-[134px] max-w-[134px] max-h-[134px] flex items-center justify-center">
          <CountUp end={count} />
          {suffix}
        </p>
        </div>
