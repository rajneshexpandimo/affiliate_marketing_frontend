...
const AllBlogs = () => {
  return (
    <div className="text-center">
      ...
      <button className="border-2 border-s-[21px] px-9 py-4 border-[#1F57A1] bg-[#E7E7E7] rounded-[5px] font-semibold uppercase mx-auto dark:text-black">
       Load More
      </button>
    </div>
  );
  ...
  return (
    <div className="w-full flex md:flex-row flex-col even:bg-white odd:bg-[#D3D3D3] even:border-b-2 border-[#33333333] even:border-0 mb-11">
      <div className="relative md:w-1/2 w-full">
        ...
        />
        <div className="flex absolute bottom-0 justify-between w-full bg-[#33333380]  px-3 text-[#fff]">
          <p className="w-1/2 flex items-center text-base gap-1 border-r py-2">
            <Image
          ...
          <p className="w-1/2 flex items-center text-base gap-1 py-2 justify-end">
            <Image
      ...
      <div className="md:w-1/2 w-full flex flex-col justify-center lg:py:[69px] py-5 lg:px-[44px] px-5">
        <h3 className="sm:text-3xl text-xl sm:leading-9 leading-none font-semibold text-[#333] dark:text-black">
          {title}
        </h3>
        <p className="text-lg py-[22px] dark:text-black">{desc}</p>
