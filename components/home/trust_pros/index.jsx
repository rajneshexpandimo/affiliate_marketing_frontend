...
const TrustThePros = () => {
  ...
  <div className="bg-[#D3D3D3] w-full py-5">
    ...
    <div className='flex sm:flex-row flex-col lg:max-w-[708px] mx-auto sm:justify-between justify-center items-center gap-4 my-10'>
    ...
    <div className='flex sm:flex-row flex-col lg:max-w-[768px] mx-auto sm:justify-between justify-center items-center gap-4 my-10'>
