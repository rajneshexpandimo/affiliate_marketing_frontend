...
const LogoSection = () => {
  return (
    <div className="md:max-w-[1300px] w-full mx-auto xl:px-0 px-5 text-center mb-10 mt-16">
      <div className="logoSectionInfo">
        <h2 className="text-5xl pb-3 font-bold ">
      ...
      <div className="logoSectionImages flex flex-wrap justify-between py-10">
        <div className="border-2 rounded-full mb-4  box-shadow w-[32%] 2xl:p-5 p-4 ">
          <img
            src="images/pmc.png"
