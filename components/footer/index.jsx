        ...
        <div className=" text-white lg:max-w-[1302px] w-full py-[59px] my-0 mx-auto">
          ...
          <div className="flex  2xl:px-0 px-5">
            ...
            <div className=" none hidden w-3/4 lg:flex items-center leading-4">
              <Link href="/" className="border-r-2  xl:px-3 lg:px-2">Legal</Link>
              <Link href="/" className="border-r-2 xl:px-3 lg:px-2">Privacy Policy</Link>
              <Link href="/" className="border-r-2  xl:px-3 lg:px-1">Terms and conditions</Link>
              <Link href="/" className="border-r-2 xl:px-3 lg:px-1">Disclaimer</Link>
              <Link href="/" className="border-r-2 xl:px-3">Your Privacy Choices</Link>
              <Link href="/" className="px-3">Ad Choices</Link>
